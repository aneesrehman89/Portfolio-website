          ...
          <div className="row featurette my-3">
            <div className="col-md-6">
              <h5 className="textColor">
                I am a Student of BSc Information Technology. I am Expert in desgin
                Web Pages responsive with Outstanding Graphic, Color, and decent interface.
                Work Experience in kodex Technology software house. Ability to do work in less time with more
                accuracy.
              </h5>
            </div>
            <div className="col-md-6">
              ...
              &nbsp;
              <div className="text-warning font-weight-bold">
                E-mail<span className="textColor"> ➤ aneesurrehman89se@gmail.com</span>
              </div>
              &nbsp;
              <div className="text-warning font-weight-bold">
            ...
            <div className="col-md-6">
              ...
              <div className="col-md-12 conbtn">
                <button type="button" className="btn btn-warning btn-lg ">
                  <Link className="text-light" to="Contact.html">
                    Contact Me
                  </Link>
                </button>
              </div>
